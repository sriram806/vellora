    ...
    <main className="container-vellora py-10 sm:py-16 lg:py-20 max-w-4xl">
      ...
      <div className="space-y-10 text-xs sm:text-sm text-foreground-secondary leading-relaxed font-light">
        <section className="space-y-3">
          <p>
            At Vellora, your privacy is of paramount importance. This Privacy Policy details how we collect, utilize, and protect the personal coordinates and transaction records of clients browsing our digital atelier and purchasing our collections.
          </p>
        ...
        <section className="space-y-4">
          ...
          <p>
            When you interact with the Vellora digital experience, we collect specific coordinates required to fulfill your requests:
          </p>
        ...
        <section className="space-y-4">
          ...
          <p>
            We process client coordinates exclusively to manage your relations with Vellora:
          </p>
          <ul className="list-disc pl-5 space-y-2">
        ...
        <section className="space-y-4">
          ...
          <p>
            Vellora utilizes industry-leading security practices:
          </p>
          <p>
        ...
        <section className="space-y-4">
          ...
          <p>
            As a Vellora client, you hold complete control over your credentials:
          </p>
          <p>
