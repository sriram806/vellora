...
export const SOCIAL_LINKS: SocialLink[] = [
  {
    platform: "Instagram",
    href: "https://instagram.com/vellora",
    icon: "instagram",
  },
  {
    platform: "Twitter",
    href: "https://twitter.com/vellora",
    icon: "twitter",
  },
  {
    platform: "Facebook",
    href: "https://facebook.com/vellora",
    icon: "facebook",
  },
  {
    platform: "Pinterest",
    href: "https://pinterest.com/vellora",
    icon: "pinterest",
  },
  {
    platform: "TikTok",
    href: "https://tiktok.com/@vellora",
    icon: "tiktok",
  },
  {
    platform: "YouTube",
    href: "https://youtube.com/@vellora",
    icon: "youtube",
  },
];
...
export const TESTIMONIALS: Testimonial[] = [
  {
    ...
    content: "VELLORA represents the rare intersection of visionary design and impeccable quality. Each piece tells a story that transcends seasonal trends.",
  ...
  },
  {
    ...
    content: "I've worn luxury brands for decades. VELLORA is the first to make me feel like I'm wearing the future. The attention to detail is extraordinary.",
  ...
  },
  {
    ...
    content: "The way VELLORA approaches garment construction reminds me of architectural design — every seam has purpose, every drape has intention.",
  ...
  },
  {
    ...
    author: "David Okafor",
    role: "Film Producer",
    content: "When I need to make an impression, I reach for VELLORA. The fabrics are unlike anything I've felt, and the fit is consistently perfect.",
  ...
  },
  {
    ...
    role: "Gallery Owner",
    content: "VELLORA doesn't just sell clothing — they curate an experience. From the packaging to the product, every touchpoint exudes sophistication.",
  ...
  },
  {
    ...
    content: "I appreciate brands that respect both tradition and innovation. VELLORA does both with a confidence that's rare in today's fashion landscape.",
